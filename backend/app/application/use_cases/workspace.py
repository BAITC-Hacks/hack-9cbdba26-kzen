...
EXPORT_COLUMNS = [
    ...
    # Срочность и обоснование — обязательная часть выхода по п. 5 ТЗ, поэтому они
    # включены по умолчанию, а не спрятаны в настройках выгрузки
    ("urgency", "Срочность"), ("status", "Статус"),
    ("manual", "Ручная корректировка"), ("reason", "Причина"), ("explanation", "Обоснование"),
    ("price", "Цена"), ("cost", "Сумма"), ("approved_by", "Утвердил"),
]
